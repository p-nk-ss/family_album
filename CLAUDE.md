...
ский заголовок/описание/обложка/ручной порядок), **ретро-подписи** (заметка
к фото пишется в редакторе альбома и читается, перевернув снимок в просмотре —
обратная сторона как у старого фото; комментарии убраны) и **бережная тёплая
визуальная идентичность** с богатой анимацией.
